...
public class Main extends Application {
  ...
  /**
   * If enter food button is pressed, jumps to the enter food page
   * 
   * @throws IOException
   */
    ...
    if (inputExerciseDate == null) {
      ...
      try {
        ...
        while ((line = input.nextLine()) != null) {
          ...
          TextField exercise = new TextField(
            "Exercise: " + st.nextToken() + "    -    Distance: " + st.nextToken()
              + "km" + "    -    Calories Burned: " + st.nextToken());
  ...
  public static void showProfileInfoSuccess() throws IOException {
    FXMLLoader loader = new FXMLLoader();
    loader.setLocation(Main.class.getResource("ProfileInfo/PROFILEINFO.fxml"));
    AnchorPane menu = loader.load();
    ...
    Label profileSubmitted = new Label("Profile Submitted");
    profileSubmitted.setTextFill(Color.RED);
    menu.setTopAnchor(profileSubmitted, 413.0);
    menu.setLeftAnchor(profileSubmitted, 700.0);
    menu.getChildren().add(profileSubmitted);

    primaryStage.setScene(enterFoodScene);
    primaryStage.show();
  }

  public static void showProfileInfoFail() throws IOException {
    FXMLLoader loader = new FXMLLoader();
    loader.setLocation(Main.class.getResource("ProfileInfo/PROFILEINFO.fxml"));
    AnchorPane menu = loader.load();
    ...
    Label profileSubmitted = new Label("Invalid Input");
    profileSubmitted.setTextFill(Color.RED);
    menu.setTopAnchor(profileSubmitted, 413.0);
    menu.setLeftAnchor(profileSubmitted, 700.0);
    menu.getChildren().add(profileSubmitted);
