...
public class NewProfileInfoController {
  ...
  @FXML
  private void goProfileInfoSuccess() throws IOException {
    main.showProfileInfoSuccess();
  }

  private void goProfileInfoFail() throws IOException {
    main.showProfileInfoFail();
  }
